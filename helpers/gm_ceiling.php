          ...
          /*  $empty_mount = true;
            ...
            if ($data["need_mount"]) {
                ...
                if ($data['n1'] == 29) {
                    ...
                    if($data['n16']){
                        $cornice = "Шторный карниз / Скрытый (Ткань)";
                    }
                    else {
                        $cornice = "Шторный карниз / Обычный (Ткань)";
                    }
                    if ($data['n11'] > 0) {
                        //внутренний вырез
                        $mounting_data[] = array(
    ...
    */
    ...
    public static function create_cut_pdf($calc_id=null,$data = null){
        try{
            ...
            $html .= '</tr>';
            $html .= '<tr>';
            $html .= '<th>Периметр:</th><td>' . $data['n5'] . 'м</td>
                      <th>Кол-во углов:</th><td>' . $data['n9'] . '</td>
                      <th>Крив. участок:</th><td>' . $data['n10'] . '</td>';
            $html .= '</tr>';
            $html .= '</tbody>';
            $html .= '</table>';
