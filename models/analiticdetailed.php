...
class Gm_ceilingModelAnaliticDetailed extends JModelList
{
	...
	function getData($date1 = null,$date2 = null,$dealer_id = null)
	{
		try
		{
            ...
            (SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE p.api_phone_id = a.id AND p.created BETWEEN '2017-11-13' AND '2017-11-14') AS common,
            (SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE p.api_phone_id = a.id AND  p.project_status = 1 AND p.project_calculation_date BETWEEN '2017-12-14 00:00:00' AND '2018-01-25 23:59:00') AS zap_zamer,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 1 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS zamer,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 2 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS otk_zam,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status  IN (4,5) AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS deal,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 3 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS otk_deal,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status IN(10,11,16,17) AND h.project_id = p.id AND a.id = p.api_phone_id AND p.project_mounting_date BETWEEN '2017-11-13' AND '2017-11-14')) AS mount,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 12 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS closed,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 15 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS refuse,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 20 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS dealer,
			(SELECT COUNT(p.id) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 21 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS advt
            (SELECT SUM(p.project_sum) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status IN(4,5) AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS sum_deal,
            (SELECT SUM(p.project_sum) FROM `#_gm_ceiling_projects` AS p WHERE  p.id IN (SELECT h.project_id FROM `#_gm_ceiling_projects_history` AS h WHERE h.new_status = 12 AND h.project_id = p.id AND a.id = p.api_phone_id AND h.date_of_change BETWEEN '2017-11-13' AND '2017-11-14')) AS sum_done
            FROM `#_gm_ceiling_api_phones` AS a */
