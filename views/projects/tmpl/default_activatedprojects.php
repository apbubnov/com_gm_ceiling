...
<form action="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=projects&type=activatedprojects'); ?>" method="post"
      name="adminForm" id="adminForm">
	  <div class="row-fluid toolbar">
		<div class="span3">
			<?php if ($canCreate) : ?>
				<a href="<?php echo JRoute::_('index.php?option=com_gm_ceiling&type=activatedprojects&task=projectform.edit&id=0', false, 2); ?>"
	...
	<table class="table table-striped one-touch-view" id="projectList">
		...
		<tbody>
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<tr data-href="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=project&type=activatedprojects&id='.(int) $item->id); ?>">
