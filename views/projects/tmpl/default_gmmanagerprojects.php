...
<h2 class="center">Проекты на обработку</h2>
<form action="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=projects&type=managerprojects'); ?>" method="post"
	...
	<table class="table table-striped one-touch-view" id="projectList">
		<thead>
			<tr>
				...
				<th class='center'>
					<?php echo JHtml::_('grid.sort',  'Дата монтажа', 'a.project_mounting_date', $listDirn, $listOrder); ?>
				</th>
				<th class='center'>
		...
		<tbody>
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<tr data-href="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=project&type=managerprojects&id='.(int) $item->id); ?>">
					<td class="center">
						<?php echo $item->id; ?>
					</td>
