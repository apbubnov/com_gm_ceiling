...
<h2 class="center">График замеров ГМ</h2>
<form action="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=projects&type=gmcalculatorprojects'); ?>" method="post"
      name="adminForm" id="adminForm">
	  <div class="row-fluid toolbar">
		<div class="span3">
			<?php if ($canCreate) : ?>
				<a href="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=addproject', false, 2); ?>"
	...
	<table class="table table-striped one-touch-view" id="projectList">
		...
		<tbody>
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<tr data-href="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=project&type=gmcalculatorprojects&id='.(int) $item->id); ?>">
