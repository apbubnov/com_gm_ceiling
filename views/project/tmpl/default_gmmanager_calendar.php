                    ...
                    <div class="span6">
                        ...
                        <?php if ($calculation->n15) { ?>
                            ...
                            <?php foreach ($calculation->n15 as $key => $n15_item) {
                                echo "<b>Количество:</b> " . $n15_item->n15_count . " шт - <b>Тип:</b>   " . $n15_item->component_title . "<br>";
                                ?>
                            <?php }
                        } ?>
                        ...
                        <?php if ($calculation->n22) { ?>
                            ...
                            <?php foreach ($calculation->n22 as $key => $n22_item) {
                                echo "<b>Количество:</b> " . $n22_item->n22_count . " шт - <b>Тип:</b>   " . $n22_item->component_title . " - <b>Размер:</b> " . $n22_item->component_title . "<br>";
                                ?>
                            <?php }
                        } ?>
                        ...
                        <?php } ?>
                        <?php if ($calculation->extra_mounting) { ?>
                        <div>
...
<script language="JavaScript">
    ...
    jQuery(document).ready(function () {
        ...
        var ne = <?php unset($_SESSION['FIO'], $_SESSION['address'],$_SESSION['house'],$_SESSION['bdq'],$_SESSION['apartment'],$_SESSION['porch'],$_SESSION['floor'],$_SESSION['code'], $_SESSION['date'], $_SESSION['time'], $_SESSION['phones'], $_SESSION['manager_comment'], $_SESSION['comments'],  $_SESSION['gauger']); echo 1;?>;
        show_comments();
