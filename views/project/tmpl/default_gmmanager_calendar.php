        ...
        <div class="row">
            <div class="item_fields">
                ...
                <form id="form-client"
                    ...
                    <input name = "project_new_calc_date" id = "jform_project_new_calc_date" class ="inputactive" value="<?php if(isset($_SESSION['date'])){ echo $_SESSION['date']; } else if (isset($this->item->project_calculator_date)) { echo $this->item->project_calculator_date;}?>" type="hidden">
