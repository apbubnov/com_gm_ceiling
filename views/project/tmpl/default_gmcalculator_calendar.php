...
foreach ($calculations1 as $calculation) {
    ...
    //Gm_ceilingHelpersGm_ceiling::print_components($data->id, $components_data);
}
                                ...
                                <td>
                                    <div class="Date" style="display: none;">
                                        ...
                                        <label id="jform_project_calculation_daypart-lbl"
                                                for="jform_new_project_calculation_daypart">Новое время замера</label>
                                        <select id="jform_new_project_calculation_daypart"
                                                name="new_project_calculation_daypart" class="inputactive"
                                                disabled="true">
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link"
            href="<?php echo JRoute::_('index.php?option=com_gm_ceiling&view=calculationform&type=gmcalculator&subtype=calendar&id=0&project_id=' . $this->item->id); ?>">
        ...
        jQuery("#mounters").change(function () {
            ...
            Array.from(DataOfProject).forEach(function(element) {
                if (element.project_mounter == id) {
                    table_projects2 += '<tr><td>'+element.project_mounting_date+'</td><td>'+element.project_info+'</td><td>'+element.n5+'</td></tr>';
                }
            });
