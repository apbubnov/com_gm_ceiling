...
<script>
	...
	var columns_array = [];
	 jQuery(document).ready(function(){
		...
		c_all_count['common'] = <?php echo !empty($c_all_common) ? $c_all_common : 0;?>;
		c_all_count['inwork'] = <?php echo !empty($c_all_inwork) ? $c_all_inwork : 0;?>;
		c_all_count['refuse'] = <?php echo !empty($c_all_refused) ? $c_all_refused : 0;?>;
		c_all_count['measure'] = <?php echo !empty($c_all_measure) ? $c_all_measure : 0;?>;
        c_all_count['deals'] = <?php echo !empty($c_all_deals) ? $c_all_deals : 0;?>;
        c_all_count['done'] = <?php echo !empty($c_all_done) ? $c_all_done : 0;?>;
        c_all_count['sum'] = <?php echo !empty($c_all_sum ) ? $c_all_sum : 0;?>;
        c_all_count['profit'] = <?php echo !empty($c_all_profit) ? $c_all_profit : 0;?>;
		...
		d_all_count['common'] = <?php echo !empty($d_all_common) ? $d_all_common : 0;?>;
		d_all_count['measure'] = <?php echo !empty($d_all_measure) ? $d_all_measure : 0;?>;
		d_all_count['refused'] = <?php echo !empty($d_all_refused) ? $d_all_refused : 0;?>;
		d_all_count['ref_measure'] = <?php echo !empty($d_all_ref_measure) ? $d_all_ref_measure : 0;?>;
        d_all_count['current_measure'] = <?php echo !empty($d_all_current_measure) ? $d_all_current_measure : 0;?>;
		d_all_count['deals'] = <?php echo !empty($d_all_deals) ? $d_all_deals : 0;?>;
		d_all_count['ref_deals'] = <?php echo !empty($d_all_ref_deals) ? $d_all_ref_deals : 0;?>;
		d_all_count['closed'] = <?php echo !empty($d_all_closed) ? $d_all_closed : 0;?>;
		d_all_count['mounts'] = <?php echo !empty($d_all_mounts) ? $d_all_mounts : 0;?>;
		d_all_count['sum_deals'] = <?php echo !empty($d_all_sum_deals) ? $d_all_sum_deals : 0;?>;
		d_all_count['sum_done'] = <?php echo !empty($d_all_sum_done) ? $d_all_sum_done : 0;?>;
