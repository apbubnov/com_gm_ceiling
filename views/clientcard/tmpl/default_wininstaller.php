...
<div style="display: inline-block; width: 48%;">
    <div>
    <p class = "caption-tar" style="font-size: 26px; color: #414099; text-align: left; margin-bottom: 0px;">Почта оконщика: </p>
    </div>
...
<div style="display: inline-block; width: 48%;">
    <div>
    <p class = "caption-tar" style="font-size: 26px; color: #414099; margin-bottom: 0px;">Телефоны оконщика: </p>
    </div>
    <div>
...
<div class="row">
    <div class="col-sm-12" id = "calls">
        <p class="caption-tar">История оконщика</p>
        <div id="calls-tar">
...
<div class="row">
    <div class="col-sm-12" id = "cliens_of_dealer">
        <p class="caption-tar">Клиенты оконщика</p>
