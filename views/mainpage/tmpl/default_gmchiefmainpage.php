...
<div class="start_page">
	<div style="width: 100%; margin-left: calc(50% - 100px); padding-bottom: 1em;">
		<div class="container-for-circl">
			<a class="btn btn-large btn-primary" href="<?php echo JRoute::_('/index.php?option=com_gm_ceiling&view=projects&type=gmchief&subtype=gaugings', false); ?>"><i class="far fa-calendar" aria-hidden="true"></i> График замеров</a>
	...
	<div style="width: 100%; margin-left: calc(50% - 100px); padding-bottom: 1em;">
		<div class="container-for-circl">
			<a class="btn btn-large btn-primary" href="<?php echo JRoute::_('/index.php?option=com_gm_ceiling&view=projects&type=gmchief', false); ?>"><i class="far fa-calendar" aria-hidden="true"></i> Монтажи</a>
	...
	<p class="center">
		...
		<div style="width: 100%; margin-left: calc(50% - 100px); padding-bottom: 1em;">
		<div class="container-for-circl">
			<a class="btn btn-large btn-primary" href="<?php echo JRoute::_('/index.php?option=com_gm_ceiling&view=mainpage&type=gmcalculatormainpage', false); ?>"><i class="fas fa-sign-in" aria-hidden="true"></i> Войти как замерщик</a>
			<?php if ($answer1[0]->count != 0) { ?>
				<div class="circl-digits"><? echo $answer1[0]->count; ?></div>
			<?php } ?>
		</div>
