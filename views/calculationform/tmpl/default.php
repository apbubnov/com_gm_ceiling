									...
									<td class="td_calcform2">
										<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
											...
											<span class="airhelp">
												...
												+ монтжаная работа по натягиванию потолка
											</span>
										</div>
									</td>
								</tr>
									...
									<td class="td_calcform2">
										<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
											...
											<span class="airhelp">
												...
												В расчет на 1 трубу входит 1 пластина + монтжаная работа по обводу трубы
											</span>
										</div>
									</td>
								</tr>
									...
									<tr>
										...
										<td class="td_calcform2">
											<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
												<div class="help_question">?</div>
												<span class="airhelp">
													В расчет считается монтжаная работа по установке багета в плитку
												</span>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="td_calcform2">
											<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
												<div class="help_question">?</div>
												<span class="airhelp">
													В расчет считается монтжаная работа по установке багета в керамогранит
												</span>
											</div>
										</td>
									</tr>
										...
										<td class="td_calcform2">
											<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
												...
												<span class="airhelp">
													...
													В расчет на 1 пожарную сигнализацию входит:<br>
													<ul style="text-align: left;">
														<li>3 дюбеля (красн. 6*51)</li>
														<li>2 клеммные колодки (2,5 мм<sup>2</sup> (Umax=450В Tmax=110C полиамид ДКС)</li>
														<li>1 круглое кольцо (50)</li>
									...
									<td class="td_calcform2">
										<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
											...
											<span class="airhelp">
												...
												<ul style="text-align: left;">
													<li>2 дюбеля (красн. 6*51)</li>
													<li>1 клеммная колодка (2,5 мм<sup>2</sup> (Umax=450В Tmax=110C полиамид ДКС)</li>
