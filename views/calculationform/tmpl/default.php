				...
				<div class="container">
					<div class="row"  style="margin-bottom: 15px;">
						...
						<div class="col-sm-4">
							...
							<input type="text" id="comment" name="jform_details" value="<?php echo $this->item->details; ?>" class="form-control"  placeholder="комментарий" style="display: none; margin-top: 20px; margin-bottom: 5px;">
						</div>
						<div class="col-sm-4"></div>
					</div>
				</div>
