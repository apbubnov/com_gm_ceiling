								...
								<tr>
									...
									<td class="td_calcform2">
										<div class="btn-primary help" style="padding: 5px 10px; border-radius: 5px; height: 38px; width: 38px; margin-left: 5px;">
											<div class="help_question">?</div>
											<span class="airhelp">
												Для перехода по прямой в расчет входит 300+ р. + маржа на комплектующие</br>
												Для перехода по кривой в расчет входит 500+ о. + маржа на комплектующие</br>
												+ монтажная работа "переход уровня по кривой или прямой"
											</span>
										</div>
									</td>
								</tr>
