                ...
                <div class="control-group">
                    <div class="controls">
                        <a class="btn btn-success"
                           href="<?php if ($userId == $user->dealer_id) echo JRoute::_('index.php?option=com_gm_ceiling&view=projects&type=gmchief&subtype=run');
                           else echo JRoute::_('index.php?option=com_gm_ceiling&view=projects&type=gmchief&subtype=run'); ?>"
                           title="">
