                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        Array.from(data).forEach(function(elem) {
                            if (selectedBrigade == elem.project_mounter and elem.project_mounting_day_off == null) {
                                BusyTimes.push(elem.project_mounting_date.substr(11));
                            } else if (selectedBrigade == elem.project_mounter and elem.project_mounting_day_off != null) {
