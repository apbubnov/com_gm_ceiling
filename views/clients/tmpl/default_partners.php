...
$clients = $clients_model->getClientsAndProjects(null,'partners');
        ...
        function print_clients(begin)
        {
            ...
            for (var i = begin, cl_i, iter = 0; i < clients_data.length; i++)
            {
                ...
                if ((search_reg.test(cl_i.client_name) || search_reg.test(cl_i.address) ||
                    search_reg.test(cl_i.client_contacts) || search_reg.test(cl_i.id) || search_reg.test(cl_i.name)) &&
                    ...
                    (label === '' || label === cl_i.label_id))
                {
                    ...
                    tr.find(".partner").text(cl_i.name);
